...
object SVMWithSGDBinary {
  ...
  def main(args: Array[String]): Unit = {
    SetLogger
    val sc = new SparkContext(new SparkConf().setAppName("svm.binary").setMaster("local[4]"))
  }
  ...
  def predictData(testData: RDD[LabeledPoint], model: SVMModel, categoriesMap: Map[String, Int]) = {
